...
public :
  ...
  virtual void SetQuantity(unsigned long, int, Short_t);       //!Individually implemented in specific detector classes 
  ...
  virtual void BuildEvent(UNIMCalibration*);                   //!Individually implemented in specific detector classes
  virtual void FillMappedData();                               //!Individually implemented in specific detector classes
  virtual void BuildCalibratedQuantities(UNIMCalibration*);    //!Individually implemented in specific detector classes
